  ...
  return (
    <>
      <Container
        ...
        className=" px-3 md:px-2"
      >
        <div className="mt-12">
          <h1
            // text-center
            className="px-2 pt-6 font-dosis text-3xl uppercase leading-9 tracking-[.4rem] text-[#141414]"
          >
            {/* My Story */}
            Blog
            {/* BUILDING A CHROME EXTENSION WITH SHARED STATE */}
          </h1>
          ...
          <div
            ...
            className="mt-6 space-y-16 pt-10"
          >
