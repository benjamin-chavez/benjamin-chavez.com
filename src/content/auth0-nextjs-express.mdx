...
**NOTE**: TODO: Next.js **middleware** only runs on navigated routes and API requests from client components. You cannot access the Next.js middleware from server components.
