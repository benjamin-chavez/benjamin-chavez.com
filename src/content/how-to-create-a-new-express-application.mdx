...
title: 'How to Create a New Express Application'
author: 'Ben Chavez'
...
## Step 2: Add The Project Dependencies
  ...
  <CodeTitle title="express-api/src/app.ts" lang="ts" />
...
## Step 3: Write your Express Server:
...
## Step 4: Run Your New Express Server

  Compile your `typscript` code. The compiled code will be saved in the `./dist` directory from [step2]() above.
  ```bash
  pnpm tsc
  ```
...
## Conclusion
  ...
  The full code repository can be found at [GITHUB REPO]().
