...
author: 'Ben Chavez'
description: 'Step-by-step guide on setting up a new Express web application with TypeScript. Learn the essentials from initializing the project to configuring the server.'
summary: 'Ben Chavez presents a comprehensive tutorial on creating a new Express web application using TypeScript. Dive into the initial setup, directory structures, and essential configurations to get your web application up and running.'
...
## 1: Create A New Directory for your application
  ...
  Change your directory so that you are inside of the newly created folder
  ```bash
  cd express-api
  ```
...
## 2: Add The Project Dependencies
  ...
  Inside of the newly creates `tsconfig.json` file, declare your `outDir`.
...
Step 6: Add hot reloading
  ...
  Next, open up you package.json and add the following `start` script. We are going to just delete the `test` script, but you can leave it if you prefer:
  ...
  > express-api@1.0.0 start /home/benchavez/Code (Ubuntu VM)/Projects/delete-me/express-api
...
## Conclusion
  ...
  Note, in a typical express server, you wouldn't have your data sitting dirrectly in your route like we did here.
