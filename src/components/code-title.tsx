...
export default function CodeTitle({ title, lang }: ICodeTitle) {
  ...
  return (
    <div className="code-title mt-4 flex w-full items-center justify-start gap-2 truncate rounded-t-lg border-b border-slate-700 bg-slate-900 px-4 py-3">
      ...
      <div className="flex w-full items-center justify-between gap-3 px-4 md:px-0">
