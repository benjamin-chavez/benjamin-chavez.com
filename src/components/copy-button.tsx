...
// export const CopyButton = ({ textInput }: CopyButtonProps) => {
...
//         type="button"
//         className={cx(
//           'absolute right-3 top-1.5 z-40 h-9 w-9 rounded  border bg-slate-900 p-1 hover:bg-slate-700',
//           copied
...
//           stroke="currentColor"
//           aria-hidden="true"
//           className={cx(copied ? 'text-green-400' : 'text-gray-300')}
//         >
//           {copied ? (
//             <>
//               <path
